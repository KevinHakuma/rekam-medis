...
if (isset($_GET['id'])) {
    ...
    $query_delete = mysqli_query($conn, "DELETE FROM rekam_medis WHERE id = $id");
        ...
        <body>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = "../rekam_medis.php"; // Redirect ke halaman data_pasien.php atau yang sesuai
                }
            });
            </script>
        </body>
