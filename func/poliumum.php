...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="side-menu">
            ...
            <li><a href="rekam_medis.php"><i class='bx bx-notepad' ></i>History Rekam Medis</a></li>
            ...
            <div class="header">
                <div class="left">
                    ...
                    <ul class="breadcrumb">
                        <li><a href="#">Home</a></li>
                        /
                        <li><a href="#" class="active">Poli Umum</a></li>
                    </ul>
                </div>
            ...
            <div class="table-container">
                ...
                <div class="table-header">
                    <table align="center">
                        ...
                        $result = mysqli_query($conn, "SELECT id, nama, tanggal_lahir, nomor_rekam_medis FROM data_pasien");
                        ...
                        $query_data = mysqli_query($conn, "SELECT id, nama, tanggal_lahir, nomor_rekam_medis FROM data_pasien WHERE poli = 'Poli Umum' LIMIT $offset, $records_per_page");
                        ...
                        while ($row = mysqli_fetch_assoc($query_data)) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="update_data.php" class="btn-edit" data-toggle="tooltip" title="Edit Data"><i class='bx bx-edit-alt' ></i></a>
                                    <a href="delete_data.php?id=<?php echo $row['id']; ?>" class="btn-delete" data-toggle="tooltip" title="Hapus Data"><i class='bx bxs-trash'></i></a>
                                </td>
                            </tr>
