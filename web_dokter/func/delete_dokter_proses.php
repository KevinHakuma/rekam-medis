...
if (isset($_GET['id'])) {
    ...
    $query_delete = mysqli_query($conn, "DELETE FROM data_dokter WHERE id_dokter = $id");
        ...
        <body>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = "../data_dokter.php"; // Redirect ke halaman data_pasien.php atau yang sesuai
                }
            });
            </script>
        </body>
