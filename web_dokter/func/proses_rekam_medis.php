...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "INSERT INTO rekam_medis (nomor_rekam_medis, nama_pasien, keluhan_utama, keluhan_tambahan, berat_badan, cara_berjalan, menopang_duduk, imt_kurang, kehilangan_bb, penurunan_asupan, sakit_berat, diagnosa)
              VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";

    // Menggunakan prepared statement untuk mencegah SQL Injection
    $stmt = $conn->prepare($query);
    $stmt->bind_param("ssssssssssss", $nomor_rekam_medis, $nama_pasien, $keluhan_utama, $keluhan_tambahan, $berat_badan, $cara_berjalan, $menopang_duduk, $imt_kurang, $kehilangan_bb, $penurunan_asupan, $sakit_berat, $diagnosa);
